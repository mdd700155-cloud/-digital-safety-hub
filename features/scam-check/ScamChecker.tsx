...
export function ScamChecker({
  ...
  /*
   * IMPORTANT:
   * When an analysis result exists, pass the original
   * content and content type to ResultDisplay.
   *
   * This allows the user to send the same suspicious
   * content to ScamWatch without typing it again.
   */
  if (result) {
    return (
      <ResultDisplay
        ...
        <div className="flex flex-col items-center space-y-5 text-center p-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-2 max-w-sm leading-relaxed">
              ...
              structural heuristics, and context. This
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground flex justify-between gap-4">
                  <span>
                    Paste any suspicious message text or SMS.
                  </span>
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Paste the full URL. We analyze its
                  structure — we do not visit the website.
                </p>
              </div>
            </TabsContent>
                ...
                {inputValue ? (
                  <div className="flex flex-col items-center">
                    ...
                    <img
                      ...
                      className="max-h-40 rounded-lg mb-4 object-contain shadow-soft"
                    />
